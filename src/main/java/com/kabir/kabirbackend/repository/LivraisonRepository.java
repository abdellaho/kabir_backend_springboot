...
public interface LivraisonRepository extends JpaRepository<Livraison, Long>, JpaSpecificationExecutor<Livraison> {
    ...
    @Query("SELECT new com.kabir.kabirbackend.dto.DetBulletinLivraisonDTO(l.id, l.mantantBLBenefice) FROM Livraison l WHERE l.dateBl between :start and :end and l.personnel.id = :repId")
